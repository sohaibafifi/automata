...
namespace Automates
{
    public partial class NfaCreation : Form
    {

        int initial = 0;
        public Nfa UserNfa = new Nfa();
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "NfaCreation";
            this.Text = "Création de Nfa";
            this.Load += new System.EventHandler(this.Nfa_creation_Load);
        ...
        private void Valide1_Click(object sender, EventArgs e)
        {
            ...
            foreach (object car in Xlist.Items)
                UserNfa.X.Add(car);
            UserNfa.S = (int)Nbetats.Value;
            UserNfa.S0 = initial;
            foreach (object etat in EtatsFList.Items)
                UserNfa.F.Add(ToInt((string)etat));
        ...
        private void supprimer_Click(object sender, EventArgs e)
        {
            if (transitions.SelectedItem != null)
            {
                ...
                UserNfa.RemoveInstruction(trip);
        ...
        private void Nfa_creation_Load(object sender, EventArgs e)
        {
