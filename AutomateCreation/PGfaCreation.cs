...
namespace Automates
{
    public partial class PGfaCreation : Form
    {

        int initial = 0;
        public PGfa UserPGfa = new PGfa();
        ...
        private void InitializeComponent()
        {
            ...
            this.EtatsFList.SelectedIndexChanged += new System.EventHandler(this.EtatsFList_SelectedIndexChanged_1);
            ...
            this.SiXSj.Size = new System.Drawing.Size(43, 106);
            ...
            this.Name = "PGfaCreation";
            this.Text = "Création de PGfa";
            this.Load += new System.EventHandler(this.PGfa_creation_Load);
        ...
        private void Valide1_Click(object sender, EventArgs e)
        {
            ...
            foreach (object car in Xlist.Items)
                UserPGfa.X.Add(car);
            UserPGfa.X.Add(Automata.EPSILON);
            UserPGfa.S = (int)Nbetats.Value;
            UserPGfa.S0 = initial;
            foreach (object etat in EtatsFList.Items)
                UserPGfa.F.Add(ToInt((string)etat));
        ...
        private void supprimer_Click(object sender, EventArgs e)
        {
            ...
            {
                Instruction trip = (Instruction)transitions.SelectedItem;
                UserPGfa.RemoveInstruction(trip);
        ...
        private void PGfa_creation_Load(object sender, EventArgs e)
        {
        ...
        private void EtatsFList_SelectedIndexChanged_1(object sender, EventArgs e)
        {
